...
public interface ProductPriceRepository extends JpaRepository<ProductPrice, Long> {
    ...
    @Query(
            "select pr from ProductPrice pr where pr.product.id = :productId and pr.supplier.id = :supplierId and pr.price " +
                    "= :price and pr.period_from = :period_from and pr.period_to = :period_to"
    )
